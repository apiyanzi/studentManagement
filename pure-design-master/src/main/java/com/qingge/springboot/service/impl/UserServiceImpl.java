...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    @Override
    public Map<String,Long> getUserCon() {
        LambdaQueryWrapper<User> queryWrapper = new LambdaQueryWrapper<>();
        LambdaQueryWrapper<User> queryWrapper1 = new LambdaQueryWrapper<>();
        queryWrapper.eq(User::getRole, "ROLE_STUDENT");
        queryWrapper1.eq(User::getRole, "ROLE_TEACHER");
        HashMap<String, Long> map = new HashMap<>();
        map.put("user", userMapper.selectCount(null));
        map.put("student", userMapper.selectCount(queryWrapper));
        map.put("teacher", userMapper.selectCount(queryWrapper1));
        return map;
    }
